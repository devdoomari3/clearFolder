...
function clearFs(args) {
    return __awaiter(this, void 0, void 0, function () {
        var fullPath, _stat, clearRules, action, stat, _a, children, childrenResult, notEmptied;
        var _this = this;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    fullPath = args.fullPath, _stat = args.stat, clearRules = args.clearRules, action = args.action;
                    _a = _stat;
                    if (_a) return [3 /*break*/, 2];
                    return [4 /*yield*/, fs_extra_1.default.lstat(fullPath)];
                case 1:
                    _a = (_b.sent());
                    _b.label = 2;
                case 2:
                ...
                case 3:
                    ...
                    return [4 /*yield*/, Promise.all(children.map(function (childPath) { return __awaiter(_this, void 0, void 0, function () {
                            var childFullPath, childStat, parsedPath, ruleMatchResults, matchingRules, nestedRules, effective, childClearRules, childAction, childResult;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        childFullPath = path_1.default.join(fullPath, childPath);
                                        return [4 /*yield*/, fs_extra_1.default.lstat(childFullPath)];
                                    case 1:
                                        childStat = _a.sent();
                                        parsedPath = path_1.default.parse(childFullPath);
                                        ruleMatchResults = clearRules.map(function (clearRule) { return (__assign({}, clearRule, { result: clearRule.matcher({
                                                fullPath: childFullPath,
                                                stat: childStat,
                                                parsedPath: parsedPath,
                                            }) })); });
                                        matchingRules = ruleMatchResults
                                            .filter(function (mr) {
                                            return mr.result === matchers_1.MatcherResult.isMatch;
                                        });
                                        nestedRules = ruleMatchResults
                                            .filter(function (mr) { return mr.result === matchers_1.MatcherResult.toChildren; })
                                            .map(function (mr) { return omit_1.default(mr, 'result'); });
                                        effective = last_1.default(matchingRules);
                                        childClearRules = flatten_1.default(matchingRules
                ...
                case 4:
                    ...
                    return [4 /*yield*/, rmRf_1.rmRf(fullPath)];
                case 5:
                    _b.sent();
